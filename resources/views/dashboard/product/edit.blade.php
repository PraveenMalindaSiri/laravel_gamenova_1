            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 space-y-6">
                ...
                <form action="{{ route('myproducts.update', $product) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-4 grid grid-cols-3 gap-4">
                        ...
                        {{-- Title --}}
                        <div class="col-span-3">
                            <x-input-field name="title" label="Title" :value="old('title', $product->title)" />
                        </div>
                        ...
                        <div class="col-span-3">
                            ...
                            <div class="w-full">
                                ...
                                <textarea name="description" rows="5"
                                    class="block w-full rounded-xl border px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                        ...
                        {{-- Age Rating --}}
                        <div>
                            <x-input-field name="age_rating" type="number" label="Age Rating" :value="old('age_rating', $product->age_rating)" />
                        </div>

                        {{-- Company --}}
                        <div>
                            <x-input-field name="company" label="Company" :value="old('company', $product->company)" />
                        </div>
                        ...
                        {{-- Genre --}}
                        <div class="mt-4">
                            <label class="mb-1 block text-sm font-medium text-gray-700">Genres</label>
                            <div class="ml-4">
