<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="role" type="text" class="mt-1 block w-full bg-gray-100"
                value="{{ ucwords($this->user->role) }}" readonly />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-text-area id="address" class="mt-1 block w-full" wire:model="state.address"></x-text-area>
